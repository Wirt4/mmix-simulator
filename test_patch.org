...
* Body
** Problem
The build failed due to a TypeScript typecheck failure
*** github actions log
#+begin_example
Run docker run --rm mmix-simulator:test bash -c "bin/setup --skip-server && bin/rake test"
...
> mmix-simulator@1.0.0 typecheck
> tsc --noEmit

test/javascript/module_adapter.test.ts(24,5): error TS2322: Type '{ ccall: Mock<Procedure>; cwrap: Mock<Procedure>; HEAPU8: Uint8Array<ArrayBufferLike>; _get_stderr_size: Mock<Procedure>; ... 19 more ...; _set_breakpoint: Mock<...>; }' is not assignable to type 'MainModule'.
  Property '_clear_breakpoint' is missing in type '{ ccall: Mock<Procedure>; cwrap: Mock<Procedure>; HEAPU8: Uint8Array<ArrayBufferLike>; _get_stderr_size: Mock<Procedure>; ... 19 more ...; _set_breakpoint: Mock<...>; }' but required in type 'WasmModule'.

 TypeScript type checking failed!

> mmix-simulator@1.0.0 test
> vitest run


 RUN  v4.1.8 /rails

 ✓ test/javascript/module_adapter.test.ts (25 tests) 52ms
 ✓ test/javascript/ide/registers.test.ts (18 tests) 151ms
 ✓ test/javascript/mmix_wasm.test.ts (7 tests) 585ms
     ✓ given a source that's syntactically correct and prints to stderr, when it is converted to assembly, then the assemble result will be clean  481ms
 ✓ test/javascript/ide/syntax_highlighter.test.ts (19 tests) 18ms
 ✓ test/javascript/ide_facade_snapshot.test.ts (13 tests) 4206ms
     ✓ listing toggle button has btn--tactile class  440ms
     ✓ initial state after connect  631ms
     ✓ special registers after connect  337ms
     ✓ good code special and general register containers outputs match snapshot  436ms
     ✓ good code run affects spinner arrow  361ms
 ✓ test/javascript/formatter.test.ts (10 tests) 47ms
 ✓ test/javascript/simulator.test.ts (23 tests) 4065ms
     ✓ on successful assembly, runUserProgram calls initializeMMIX  801ms
     ✓ on successful assembly, runUserProgram calls initializeMMIX with command line arguments  825ms
     ✓ on successful assembly, runUserProgram calls finalizeMMIX  803ms
     ✓ on successful assembly, runUserProgram calls isHalted()  at least once  801ms
     ✓ on successful assembly, and isHalted = false runUserProgram calls performInstructions()  at least once  801ms
 ✓ test/javascript/ide/registers_panel.test.ts (5 tests) 33ms
 ✓ test/javascript/ide/tabbed_registers.test.ts (6 tests) 39ms
 ✓ test/javascript/ide/listing.test.ts (10 tests) 420ms
 ✓ test/javascript/ide/syntax_highlighter_snapshot.test.ts (8 tests) 18ms
 ✓ test/javascript/output_panel.test.ts (11 tests) 643ms
 ✓ test/javascript/ide/arguments.test.ts (6 tests) 13ms
 ✓ test/javascript/ide/input.test.ts (2 tests) 183ms

 Test Files  14 passed (14)
      Tests  163 passed (163)
   Start at  20:46:00
   Duration  11.59s (transform 787ms, setup 0ms, import 1.69s, tests 10.47s, environment 13.33s)


up to date, audited 192 packages in 703ms
...
> mmix-simulator@1.0.0 build
> esbuild app/javascript/application.ts --bundle --sourcemap --format=iife --outdir=app/assets/builds --public-path=/assets
...
⚡ Done in 70ms
Running 86 tests in parallel using 4 processes
Run options: --seed 2867

# Running:

......................................................................................

Finished in 3.911271s, 21.9877 runs/s, 51.9013 assertions/s.
86 runs, 203 assertions, 0 failures, 0 errors, 0 skips
...
#+RESULTS:
test/javascript/module_adapter.test.ts(23,3): error TS2322: Type '{ ccall: Mock<Procedure>; cwrap: Mock<Procedure>; HEAPU8: Uint8Array<ArrayBufferLike>; _get_stderr_size: Mock<Procedure>; ... 19 more ...; _set_breakpoint: Mock<...>; }' is not assignable to type 'MainModule'.
  Property '_clear_breakpoint' is missing in type '{ ccall: Mock<Procedure>; cwrap: Mock<Procedure>; HEAPU8: Uint8Array<ArrayBufferLike>; _get_stderr_size: Mock<Procedure>; ... 19 more ...; _set_breakpoint: Mock<...>; }' but required in type 'WasmModule'.
...
#+end_src
*** module adapter test
#+begin_src typescript :noweb yes :tangle test/javascript/module_adapter.test.ts
